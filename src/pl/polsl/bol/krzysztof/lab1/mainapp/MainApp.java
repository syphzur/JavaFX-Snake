package pl.polsl.bol.krzysztof.lab1.mainapp;
...
import pl.polsl.bol.krzysztof.lab1.controller.Controller;
...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        //loading fxml view
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/pl/polsl/bol/krzysztof/lab1/view/View.fxml"));
